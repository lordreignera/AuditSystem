...
@section('title', 'Create New Audit - Health Audit System')
        ...
        <div class="d-flex justify-content-between flex-wrap">
            <div class="d-flex align-items-end flex-wrap">
                <div class="me-md-3 me-xl-5">
                    <h2 class="mb-3 mb-md-0">Create New Audit</h2>
                </div>
            </div>
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.audits.store') }}" method="POST" id="audit-form">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="duration_value" id="duration_value" value="{{ old('duration_value') }}" min="1" class="form-control">
                        </div>
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary">
                            <i class="mdi mdi-content-save"></i> Create Audit
                        </button>
