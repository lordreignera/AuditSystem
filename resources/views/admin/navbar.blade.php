<div class="container-fluid page-body-wrapper">
        ...
        <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
          <a class="custom-brand" href="index.html">AUDIT TOOL SYSTEM</a>
        </div>
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="createbuttonDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content">
                      <p class="preview-subject ellipsis mb-1" href="{{url ('add_product')}}">Patient</p>
                    </div>
                  </a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content">
                      <p class="preview-subject ellipsis mb-1" href="{{url ('addappointment')}}">Appointment</p>
                    </div>
                  </a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item preview-item">
                  ...
                  <div class="dropdown-divider"></div>
                  <p class="p-3 mb-0 text-center">view all reviews</p>
                </div>
              </li>
