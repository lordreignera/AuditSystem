    ...
    public function run(): void
    {
        ...
        $audits = [
            [
                ...
                'country_id' => $countries->where('iso_code', 'UG')->first()?->id ?? $countries->first()->id,
            ...
            [
                ...
                'country_id' => $countries->where('iso_code', 'SL')->first()?->id ?? $countries->first()->id,
            ...
            [
                ...
                'country_id' => $countries->where('iso_code', 'KE')->first()?->id ?? $countries->first()->id,
            ...
            [
                ...
                'country_id' => $countries->where('iso_code', 'NG')->first()?->id ?? $countries->first()->id,
            ...
            [
                ...
                'country_id' => $countries->where('iso_code', 'GH')->first()?->id ?? $countries->first()->id,
            ...
            [
                ...
                'country_id' => $countries->where('iso_code', 'RW')->first()?->id ?? $countries->first()->id,
